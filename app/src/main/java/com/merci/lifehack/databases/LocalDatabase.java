package com.merci.lifehack.databases;
...
import com.merci.lifehack.models.ObjectSerializer;
...
public class LocalDatabase {
    ...
    public String getAndroidID() {
        return preferences.getString(context.getString(R.string.ANDROIDID), "");
    }

    public void setAndroidID(String androidID) {
        editor.putString(context.getString(R.string.ANDROIDID), androidID);
        editor.commit();
    }
